...
const AboutSection = () => {
  return (
    <section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <h2 className="text-heading mb-6" style={{ color: '#1a5c4a' }}>
                Команда экспертов с{' '}
                <span style={{ color: '#1a5c4a' }}>10-летним опытом</span>
              </h2>
              ...
              <div className="rounded-xl p-5 border-l-4" style={{ backgroundColor: '#f9f8f9', borderLeftColor: '#1a5c4a' }}>
                <p className="font-semibold text-body-lg" style={{ color: '#1a5c4a' }}>
            ...
            <div className="rounded-2xl p-7 border-2" style={{ backgroundColor: '#f9f8f9', borderColor: '#e8f0f1' }}>
              <div className="flex items-center gap-3 mb-6 pb-5" style={{ borderBottom: '1px solid #e8f0f1' }}>
                <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#1a5c4a' }}>
                  <Icon name="MapPin" size={16} style={{ color: '#ffe1a2' }} />
                </div>
                <span className="font-bold" style={{ color: '#1a5c4a', fontSize: '1rem' }}>Наши локации</span>
              </div>
              <div className="space-y-1 mb-6">
                {locations.map((loc) => (
                  <div key={loc} className="flex items-center gap-3 py-2.5" style={{ borderBottom: '1px solid #f0f4f4' }}>
                    <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: '#1a5c4a' }} />
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={s.label} className="rounded-xl p-4 text-center" style={{ backgroundColor: '#1a5c4a' }}>
      ...
      {/* Bonuses — teal bg */}
      <div className="py-14 md:py-20 px-6 md:px-12" style={{ backgroundColor: '#1a5c4a' }}>
        <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#ffe1a2' }}>
                    <Icon name={b.icon} size={18} style={{ color: '#1a5c4a' }} />
                  </div>
