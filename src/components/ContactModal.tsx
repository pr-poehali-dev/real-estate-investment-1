...
const ContactModal = ({ isOpen, onClose }: ContactModalProps) => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'rgba(7,73,82,0.7)', backdropFilter: 'blur(4px)' }}
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        >
          <Icon name="X" size={16} style={{ color: '#074952' }} />
        </button>

        {status === 'success' ? (
          <div className="text-center py-6">
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5" style={{ backgroundColor: '#e8f7f0' }}>
              <Icon name="CheckCircle" size={32} style={{ color: '#074952' }} />
            </div>
            <h3 className="font-bold text-xl mb-2" style={{ color: '#074952' }}>Заявка отправлена!</h3>
            ...
            <button
              ...
              style={{ backgroundColor: '#074952', color: '#ffe1a2', fontSize: '0.95rem' }}
            >
              Закрыть
            </button>
          </div>
          ...
          <>
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-xl" style={{ color: '#074952' }}>Персональный разбор</h3>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block font-bold text-sm mb-1.5" style={{ color: '#074952' }}>Имя</label>
                <input
                  type="text"
                  required
                  value={name}
              ...
              <div>
                <label className="block font-bold text-sm mb-1.5" style={{ color: '#074952' }}>Телефон</label>
                <input
                  type="tel"
                  required
                  value={phone}
