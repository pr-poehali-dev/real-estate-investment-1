...
const reasons = [
  ...
  {
    icon: 'Building2',
    title: 'Более 50% ЖК и апартаментов из рекламы не принесут вам доход',
    text: 'Пассивный доход — тренд. Но слабая УК, неправильная локация и сырая концепция, убивают доходность. В канале рассказываем все о тонкостях инветирования.',
  },
  {
    icon: 'Brain',
    title: 'Психология покупки недвижимости для жизни',
    text: 'Ликвидность, рост стоимости актива и концепция. Это не привилегия инвесторов. Покупая правильную недвижимость для себя, вам проще будет регулярно улучшать свои жилищные условия',
  },
];

const AboutSectionVse = () => {
  return (
    <section>
      {/* About — white bg */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="reveal">
              ...
              <p className="text-body-lg mb-4" style={{ color: '#1a3336' }}>Мы эксперты по недвижимости.
Не продаём убитую вторичку. Работаем только с доходными апартаментами и современными ЖК.

</p>
              <p className="text-body-lg mb-6 font-normal" style={{ color: '#1a3336' }}>Нас признают крымские застройщики — мы помогаем покупателям не ошибиться там, где другие агенты просто «продают красивую картинку». А также организуем инвестиции под ключ. От покупки недвижимости до сдачи в управление.</p>
            ...
            <div className="reveal reveal-d2 flex flex-col gap-5">
              ...
              <div className="rounded-2xl p-7 border" style={{ backgroundColor: '#18352e', borderColor: '#18352e' }}>
                ...
                <p className="text-body-lg mb-4" style={{ color: 'rgba(255,255,255,0.85)', lineHeight: '1.7' }}>Приобретение недвижимости в Крыму — это не просто покупка, а стратегия по созданию капитала и пассивного дохода. В канале делимся цифрами, инсайдами и лотами, которые не найти в открытых источниках.</p>
                <p className="text-body-lg" style={{ color: 'rgba(255,255,255,0.85)', lineHeight: '1.7' }}>
                  Сегодня вы можете чувствовать себя так же. Покупая современные апартаменты и ЖК, вы не просто получаете квадратные метры. Вы становитесь частью новой истории Крыма — возрождения его инвестиционной и курортной привлекательности.
                </p>
              </div>
              ...
              <div className="rounded-2xl p-7 border" style={{ backgroundColor: '#f9f8f9', borderColor: '#e8f0f1' }}>
                <div className="flex items-start gap-4">
                  ...
                  <p className="font-bold" style={{ color: '#18352e', fontSize: 'clamp(1rem, 2vw, 1.2rem)', lineHeight: '1.5' }}>
                    Наслаждайтесь красотой Крыма. Покупайте с холодным расчётом
                  </p>
                </div>
              </div>
...
export default AboutSectionVse;