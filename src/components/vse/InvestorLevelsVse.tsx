...
const items = [
  {
    num: '01',
    icon: 'Gem',
    title: 'Вы хотите научиться отличать хайп от перспективных районов и ЖК',
  ...
  },
  {
    num: '02',
    icon: 'BarChart2',
    title: 'Вы цените качество, ликвидность и перспективы',
    text: 'Никаких старых и убитых квартир и домов. Только современная недвижимость для жизни, отдыха и инвестиций.',
  },
  {
    num: '03',
    icon: 'ShieldCheck',
    title: 'Для инвесторов в недвижимость Крыма',
    text: 'Инвестиции — стратегия входа, налоги, выход. Мы не обещаем золотых гор, а показываем реальные риски и доходность.',
  },
];

const InvestorLevelsVse = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        <div className="reveal text-center mb-12">
          ...
          <h2 className="text-heading" style={{ color: '#18352e' }}>
            Сообщество для тех,<br />
            <span style={{ color: '#18352e' }}>кто готов вкладываться в свое будущее</span>
          </h2>
        </div>
...
export default InvestorLevelsVse;
