...
const features = [
  {
    icon: 'BarChart3',
    title: 'Аналитика и сравнение инвестиционной недвижимости',
  ...
  },
  {
    ...
    desc: 'В каких районах и комплексах в Крыму купить недвижимость, чтобы совмещать отдых и пассивный доход',
  },
  {
    icon: 'MessageCircle',
    title: 'Где лучше купить недвижимость для переезда в Крым',
    desc: 'Все про районы Крыма с самой современной инфраструктурой для жизни',
  },
];
...
const sections = [
  {
    icon: 'BarChart2',
    title: 'Аналитика и цифры для инвесторов',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'AlertTriangle', text: 'Разборы и сравнение жилых комплексов для жизни, отдыха и инвестиций' },
    ],
  },
];

const FeaturesSectionVse = () => {
  return (
        ...
        >
          ...
          <div>
            ...
            <p className="font-bold mb-1" style={{ color: '#ffffff', fontSize: '1.1rem', lineHeight: '1.4' }}>
              Чек-лист «5 вопросов застройщику, которые не задают 90% покупателей»
            </p>
...
export default FeaturesSectionVse;
