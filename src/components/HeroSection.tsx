    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden" style={{ backgroundColor: '#18352e' }}>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-20 pb-8 pt-4">
        <div className="max-w-3xl">
          ...
          <p className="hero-sub text-body-lg mb-10 max-w-xl" style={{ color: '#ffffff' }}>Сообщество тех, кто вкладывает в Крым с умом и душой. Помогаем разобраться в доходных апартаментах и отелях ЮБК, сравнить проекты, проверить УК и купить актив для пассивного дохода и личного отдыха</p>
